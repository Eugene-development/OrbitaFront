    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
      <div class="text-lg max-w-prose mx-auto">
        <h1>
          ...
          <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Строительные бригады</span>
        </h1>
        <p class="mt-8 text-xl text-gray-500 leading-8">Строительным бригадам наша компания предлагает особые условия сотрудничества.</p>
      </div>
      <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
        <ul>
          <li>гибкая система скидок.</li>
          <li>индивидуальный подход к доставке строительных и отделочных материалов до объекта.</li>
        </ul>
