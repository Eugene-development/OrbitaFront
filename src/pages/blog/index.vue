<template>
  <div class="">
    <section class="text-gray-500 body-font z-10">
      <div class="px-5 py-24 mx-auto">
        <div class="flex flex-wrap -m-4">
          <div class="p-4 lg:w-1/3">
            <div class="h-full bg-black px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
              <h2 class="tracking-widest text-xs title-font font-medium text-gray-600 mb-1">CATEGORY111</h2>
              ...
              <a class="text-red-800 inline-flex items-center">Подробнее
