<template>
  <div class="">
    ...
    <!--      </span>-->
    <!--          </div>-->
    <!--          <input type="text" id="price" class="focus:ring-red-500 focus:border-red-500 block w-full pl-7 pr-12 sm:text-sm border-gray-300 rounded-md" placeholder="0.00">-->
    <!--          <div class="absolute inset-y-0 right-0 flex items-center">-->
    <!--            <label for="currency" class="sr-only">Категория</label>-->
    <!--            <select id="Currency" class="focus:ring-red-500 focus:border-red-500 h-full py-0 pl-2 pr-7 border-transparent bg-transparent text-gray-500 sm:text-sm rounded-md">-->
      ...
      <div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-3 lg:gap-8">
        <div class="relative lg:-my-8">
          ...
          <div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:p-0 lg:h-full">
            <div class="aspect-w-10 aspect-h-6 rounded-xl shadow-xl overflow-hidden sm:aspect-w-16 sm:aspect-h-7 lg:aspect-none lg:h-full shadow-2xl">
              <img class="object-cover lg:h-full lg:w-full" src="https://lumen-image-bucket.s3.eu-central-1.amazonaws.com/pages/stroimat.jpg" alt="">
            </div>
          </div>
        </div>
        <div class="mt-12 lg:m-0 lg:col-span-2 lg:pl-8">
          <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:px-0 lg:py-20 lg:max-w-none">
            <blockquote>
              <div>
                <svg class="h-12 w-12 text-blueGray-800 opacity-25" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
                  <path d="M9.352 4C4.456 7.456 1 13.12 1 19.36c0 5.088 3.072 8.064 6.624 8.064 3.36 0 5.856-2.688 5.856-5.856 0-3.168-2.208-5.472-5.088-5.472-.576 0-1.344.096-1.536.192.48-3.264 3.552-7.104 6.624-9.024L9.352 4zm16.512 0c-4.8 3.456-8.256 9.12-8.256 15.36 0 5.088 3.072 8.064 6.624 8.064 3.264 0 5.856-2.688 5.856-5.856 0-3.168-2.304-5.472-5.184-5.472-.576 0-1.248.096-1.44.192.48-3.264 3.456-7.104 6.528-9.024L25.864 4z" />
                </svg>
                <p class="mt-6 text-2xl font-medium text-blueGray-800">
                  База стройматериалов "Орбита-Строй" предлагает в сезоне 2021 года наилучшие предложения по ассортименту и ценам на строительные и отделочные материалы, а так же на напольные покрытия и метизную продукцию. Находится наш строительный магазин на выезде из Дзержинска недалеко от Нижнего Новгорода. Если вас интересуют стройматериалы в Дзержинске, то мы ждём Вас на нашей базе!                </p>
              </div>
              <footer class="mt-6">
                <p class="text-base font-medium text-blueGray-800">Сорокин Сергей Владимирович</p>
    ...
    <section class="bg-gray-900">
      <div class="max-w-7xl mx-auto md:grid md:grid-cols-2 md:px-6 lg:px-8">
        <div
          ...
          <div class="md:flex-shrink-0 text-2xl text-gray-100">
            <h2>
              ООО "РемСтройМонтаж"
            </h2>
          ...
          <blockquote class="mt-6 md:flex-grow md:flex md:flex-col">
            <div class="relative text-lg font-medium text-white md:flex-grow">
              ...
              <br>
              <p class="relative">
                АО "Ремстроймонтаж" выражает признательность команде "Орбита-Строй" за
                профессионализм и оперативность качественного подбора строительных материалов.
                Высокий профессиональный уровень сотрудников Вашей компании помогает решать
                множество проблем в области поставок строительных материалов на объекты нашего
                предприятия.
              </p>
            </div>
            <footer class="mt-8">
        ...
        <div class="py-12 px-4 border-t-2  sm:px-6 md:py-16 md:pr-0 md:pl-10 md:border-t-0 md:border-l lg:pl-16">
          <div class="md:flex-shrink-0 text-2xl text-gray-100">
            <h2>
              ООО "ПСГ" Химрегион
            </h2>
          ...
          <blockquote class="mt-6 md:flex-grow md:flex md:flex-col">
            <div class="relative text-lg font-medium text-white md:flex-grow">
              ...
              <p class="relative">
                ...
                Очень надеемся на дальнейшее сотрудничество с Вами.
              </p>
            </div>
            <footer class="mt-8">
              <div class="flex">
        ...
        <div class="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
          ...
          <div class="mt-8 lg:mt-0">
            <div class="text-base max-w-prose mx-auto lg:max-w-none">
              <p class="mt-1 prose prose-indigo text-gray-500 mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1">Компания «Орбита Строй» – это не просто стройбаза, это надежный партнер, сотрудничающий с организациями, строительно-ремонтными бригадами, частными лицами и розничными продавцами! Клиенты приобретают стройматериалы в Дзержинске с доставкой до объекта или на условиях самовывоза.</p>
            </div>
            <div class="mt-3 prose prose-indigo text-gray-500 mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1">
              <p>В перечне товаров базы «Орбита Строй» представлено все необходимое для комплектации ассортимента строительного магазина или оснащения бригады рабочих для выполнения профессиональных задач. Клиентам предоставляется возможность заказать инструмент, сантехнику, изоляцию, электротовары, строительные и отделочные материалы по выгодным ценам. Покупателям товаров на строительной базе «Орбита Строй» доступны различные акции лояльности, позволяющие значительно сэкономить на приобретении стройматериалов и инструментов.</p>
              <p>Компания «Орбита Строй» открыла два строительных магазина в Дзержинске: на проспекте Ленина и на улице Космонавтов – последняя площадка работает 7 дней в неделю, включая воскресенье. Вам нужен надежный партнер, у которого можно в любое время приобрести все необходимое для строительства, ремонта, а также инструменты для каменщиков, плотников, отделочников и других мастеров? Обращайтесь в компанию «Орбита Строй» за следующими товарами: </p>
              <ul>
                <li>Строительные материалы</li>
                <li>Материалы для отделки помещений</li>
                <li>Электротовары и сантехника</li>
              </ul>
            </div>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      title: 'Орбита-строй || База строительных материалов в Дзержинске Нижегородской области',
      description: 'Заказ строительных и отделочных материалов на базе стойматериалов в Дзержинске с доставкой. Наш интернет магазин строительный. Есть стройбаза в черте города.',
    }
  },
  head() {
    return {
