...
<!--            </svg>-->
          ...
          <p class="mt-6 pt-2 text-3xl md:text-center text-gray-100">8 (930) 688-88-62, 8 (902) 303-36-54</p>
        ...
        <div class="max-w-xs object-right justify-end">
          ...
          <NuxtLink
            ...
            to="/shop/cart">
          <div>
            <svg class="w-24 h-24 text-red-700 text-right " fill="none" stroke="currentColor" viewBox="0 0 24 24"
                 xmlns="http://www.w3.org/2000/svg">
              <path
